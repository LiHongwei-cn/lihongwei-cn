...
## 👑 MUNDO Agent v1.6.0 — THE EMPEROR
...
| 平台 | 下载 |
|------|------|
| macOS | [mundo-v1.6.0-macos.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.6.0/mundo-v1.6.0-macos.zip) |
| Windows | [mundo-v1.6.0-windows.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.6.0/mundo-v1.6.0-windows.zip) |
| Linux | [mundo-v1.6.0-linux.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.6.0/mundo-v1.6.0-linux.zip) |
| 全平台 | [mundo-v1.6.0-all.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.6.0/mundo-v1.6.0-all.zip) |
...
### MUNDO Agent v1.6.0 — Independent AI Agent
...
### MUNDO Agent v1.6.0 — 独立 AI Agent
...
### MUNDO Agent v1.6.0 — 독립 AI Agent
