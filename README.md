...
## 👑 MUNDO Agent v1.0.19 — 独立 AI Agent
...
```
发现新版本 v28.1.0（当前 v29.5.0）。输入 /update 更新。
```
...
| 平台 | 下载 |
|------|------|
| macOS | [mundo-v1.0.19-macos.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.0.19/mundo-v1.0.19-macos.zip) |
| Windows | [mundo-v1.0.19-windows.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.0.19/mundo-v1.0.19-windows.zip) |
| Linux | [mundo-v1.0.19-linux.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.0.19/mundo-v1.0.19-linux.zip) |
| 全平台 | [mundo-v1.0.19-all.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.0.19/mundo-v1.0.19-all.zip) |
...
### MUNDO Agent v1.0.19 — Independent AI Agent
...
### MUNDO Agent v1.0.19 — 독립 AI Agent
