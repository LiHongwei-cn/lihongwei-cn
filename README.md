...
## 👑 MUNDO Agent v1.3.2 — THE EMPEROR
...
| 平台 | 下载 |
|------|------|
| macOS | [mundo-v1.3.2-macos.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.3.2/mundo-v1.3.2-macos.zip) |
| Windows | [mundo-v1.3.2-windows.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.3.2/mundo-v1.3.2-windows.zip) |
| Linux | [mundo-v1.3.2-linux.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.3.2/mundo-v1.3.2-linux.zip) |
| 全平台 | [mundo-v1.3.2-all.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.3.2/mundo-v1.3.2-all.zip) |
...
### MUNDO Agent v1.3.2 — Independent AI Agent
...
### MUNDO Agent v1.3.2 — 独立 AI Agent
...
### MUNDO Agent v1.3.2 — 독립 AI Agent
