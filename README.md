...
## 👑 MUNDO Agent v1.4.1 — THE EMPEROR
...
| 平台 | 下载 |
|------|------|
| macOS | [mundo-v1.4.1-macos.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.4.1/mundo-v1.4.1-macos.zip) |
| Windows | [mundo-v1.4.1-windows.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.4.1/mundo-v1.4.1-windows.zip) |
| Linux | [mundo-v1.4.1-linux.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.4.1/mundo-v1.4.1-linux.zip) |
| 全平台 | [mundo-v1.4.1-all.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v1.4.1/mundo-v1.4.1-all.zip) |
...
### MUNDO Agent v1.4.1 — Independent AI Agent
...
### MUNDO Agent v1.4.1 — 独立 AI Agent
...
### MUNDO Agent v1.4.1 — 독립 AI Agent
