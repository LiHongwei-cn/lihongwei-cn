...
| **AI热点日报** | 每日自动追踪AI领域动态，多源数据抓取+AI分析，生成结构化热点日报 |
| **云仓库系统** | 双向同步、质量评分(0-100)、SHA-256去重、每日自动进化、每周质量审计 |
...
| **云仓库与自动化** | 双向同步(本地↔云端)、质量评分(0-100)、去重引擎、每日自动进化、每周质量审计、**1208个skills**（含1229个汽车电子） |
...
| 平台 | 下载 |
|------|------|
| macOS | [mundo-v22.0-macos.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v22.0/mundo-v22.0-macos.zip) |
| Windows | [mundo-v22.0-windows.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v22.0/mundo-v22.0-windows.zip) |
| Linux | [mundo-v22.0-linux.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v22.0/mundo-v22.0-linux.zip) |
...
| **Cloud Repository** | Two-way sync, quality scoring (0-100), SHA-256 dedup, daily auto-evolution, weekly audit, **1208 skills** (incl. 1229 automotive) |
...
| **クラウドリポジトリ** | 双方向同期、品質スコア(0-100)、SHA-256重複排除、毎日自動進化、毎週品質監査、**1208スキル**（1229自動車含む） |
...
| **클라우드 저장소** | 양방향 동기화, 품질 점수(0-100), SHA-256 중복 제거, 매일 자동 진화, 주간 품질 감사, **1208 스킬** (자동차 1229 포함) |
