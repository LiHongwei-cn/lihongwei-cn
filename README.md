...
```
发现新版本 v25.0.0（当前 v24.5.0）。输入 /update 更新。
```
...
| 全平台 | [mundo-v25-all.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v25.0/mundo-v25-all.zip) |
...
### MUNDO Agent v25.0 — Independent AI Agent
