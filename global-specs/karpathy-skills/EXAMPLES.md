...
|-----------|--------------|-----|
| Think Before Coding | Silent assumptions | State assumptions, ask when uncertain |
| Think Before Coding | Pick one interpretation | Present multiple options |
| Simplicity First | Over-abstraction | Start simple, add complexity when needed |
| Simplicity First | Speculative features | Only build what's asked |
| Surgical Changes | Drive-by refactoring | Only change what's requested |
| Surgical Changes | Style drift | Match existing conventions |
| Goal-Driven Execution | Vague goals | Define verifiable success criteria |
| Goal-Driven Execution | Big bang changes | Incremental with verification |
