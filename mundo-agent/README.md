...
精确、克制、有分量。像一个有洁癖的外科医生，每一刀都有目的，没有多余动作。
...
| 平台 | 下载 |
|------|------|
| macOS | [mundo-v2.1.2-macos.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v2.1.2/mundo-v2.1.2-macos.zip) |
| Windows | [mundo-v2.1.2-windows.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v2.1.2/mundo-v2.1.2-windows.zip) |
| Linux | [mundo-v2.1.2-linux.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v2.1.2/mundo-v2.1.2-linux.zip) |
| 全平台 | [mundo-v2.1.2-all.zip](https://github.com/LiHongwei-cn/lihongwei-cn/releases/download/mundo-v2.1.2/mundo-v2.1.2-all.zip) |
...
| 版本 | 日期 | 说明 |
|------|------|------|
| v2.1.2 | 2026-06-12 | **核心系统**：蒙多 Agent 7大模块（协同进化/无限上下文/自进化/工作流编排） |
| v2.1.1 | 2026-06-10 | **稳定版**：帝皇无上限、工具循环防护 |
