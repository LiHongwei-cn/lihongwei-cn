...
蒙多不信任单一来源。蒙多直连 28 个 AI 模型（MiMo/DeepSeek/Qwen/GLM/Kimi/ERNIE/豆包/OpenAI/Claude/Gemini/Mistral/Grok/OpenRouter...），搜索阶段并行查多源输出，提取共同模式，整合最佳部分。

完整模型目录和 API 陷阱见 `references/mundo-agent-architecture.md`。
流程同统一七步（见工作流程）。
---
## 🕷️ 网络爬取
